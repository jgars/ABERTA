...
def process_21():
    full_wave_enhanced_audio_path = 'data/adresso21/diagnosis/train/audio/ad'
    process_path(full_wave_enhanced_audio_path, audio_dir_name='audio', remove_name='')
    full_wave_enhanced_audio_path = 'data/adresso21/diagnosis/train/audio/cn'
    process_path(full_wave_enhanced_audio_path, audio_dir_name='audio', remove_name='')
    full_wave_enhanced_audio_path = 'data/adresso21/diagnosis/test-dist/audio'
    process_path(full_wave_enhanced_audio_path, audio_dir_name='audio', remove_name='')
